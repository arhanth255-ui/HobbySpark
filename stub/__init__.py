...
#getall()
__all__=['ActiveBuzzer', 'AdafruitFeatherESP32S2', 'AdafruitFeatherM0', 'Analog', 'Any', 'ArduinoDue', 'ArduinoGigaR1', 'ArduinoLeonardo', 'ArduinoLilyPad', 'ArduinoMega2560', 'ArduinoMicro', 'ArduinoMini', 'ArduinoNano', 'ArduinoNanoESP32', 'ArduinoNanoEvery', 'ArduinoProMini', 'ArduinoUnoR3', 'ArduinoUnoWiFiRev2', 'ArduinoZero', 'BLUE', 'BROWN', 'Board', 'BoardError', 'BoardNotDefinedError', 'BoardNotInitializedFirstError', 'Button', 'DARK_GRAY', 'DO_I_NEED_BRACES', 'DeviceNotCompatibleWithCurrentBoardError', 'Digital', 'Driver', 'EEPROM', 'ESP32C3', 'ESP32DevKit', 'ESP32S2', 'ESP32S3', 'ESP8266D1Mini', 'ESP8266NodeMCU', 'FunctionType', 'GOLD', 'GRAY', 'GREEN', 'HobbySparkBoard', 'Http', 'I2C_LCD_Display', 'IMPORTANT', 'InvalidArgumentError', 'InvalidPinTypeError', 'LEFT', 'LIGHT_BLUE', 'LIGHT_GRAY', 'LIME', 'Led', 'MAGENTA', 'MCUpin', 'MS', 'MicroControllerError', 'ModuleType', 'NAVY', 'NOTE_A1', 'NOTE_A2', 'NOTE_A3', 'NOTE_A4', 'NOTE_A5', 'NOTE_A6', 'NOTE_A7', 'NOTE_AF1', 'NOTE_AF2', 'NOTE_AF3', 'NOTE_AF4', 'NOTE_AF5', 'NOTE_AF6', 'NOTE_AF7', 'NOTE_AS1', 'NOTE_AS2', 'NOTE_AS3', 'NOTE_AS4', 'NOTE_AS5', 'NOTE_AS6', 'NOTE_AS7', 'NOTE_B1', 'NOTE_B2', 'NOTE_B3', 'NOTE_B4', 'NOTE_B5', 'NOTE_B6', 'NOTE_B7', 'NOTE_BF1', 'NOTE_BF2', 'NOTE_BF3', 'NOTE_BF4', 'NOTE_BF5', 'NOTE_BF6', 'NOTE_BF7', 'NOTE_C1', 'NOTE_C2', 'NOTE_C3', 'NOTE_C4', 'NOTE_C5', 'NOTE_C6', 'NOTE_C7', 'NOTE_C8', 'NOTE_CS1', 'NOTE_CS2', 'NOTE_CS3', 'NOTE_CS4', 'NOTE_CS5', 'NOTE_CS6', 'NOTE_CS7', 'NOTE_D1', 'NOTE_D2', 'NOTE_D3', 'NOTE_D4', 'NOTE_D5', 'NOTE_D6', 'NOTE_D7', 'NOTE_DF1', 'NOTE_DF2', 'NOTE_DF3', 'NOTE_DF4', 'NOTE_DF5', 'NOTE_DF6', 'NOTE_DF7', 'NOTE_DS1', 'NOTE_DS2', 'NOTE_DS3', 'NOTE_DS4', 'NOTE_DS5', 'NOTE_DS6', 'NOTE_DS7', 'NOTE_E1', 'NOTE_E2', 'NOTE_E3', 'NOTE_E4', 'NOTE_E5', 'NOTE_E6', 'NOTE_E7', 'NOTE_EF1', 'NOTE_EF2', 'NOTE_EF3', 'NOTE_EF4', 'NOTE_EF5', 'NOTE_EF6', 'NOTE_EF7', 'NOTE_F1', 'NOTE_F2', 'NOTE_F3', 'NOTE_F4', 'NOTE_F5', 'NOTE_F6', 'NOTE_F7', 'NOTE_FS1', 'NOTE_FS2', 'NOTE_FS3', 'NOTE_FS4', 'NOTE_FS5', 'NOTE_FS6', 'NOTE_FS7', 'NOTE_G1', 'NOTE_G2', 'NOTE_G3', 'NOTE_G4', 'NOTE_G5', 'NOTE_G6', 'NOTE_G7', 'NOTE_GF1', 'NOTE_GF2', 'NOTE_GF3', 'NOTE_GF4', 'NOTE_GF5', 'NOTE_GF6', 'NOTE_GF7', 'NOTE_GS1', 'NOTE_GS2', 'NOTE_GS3', 'NOTE_GS4', 'NOTE_GS5', 'NOTE_GS6', 'NOTE_GS7', 'ORANGE', 'PINK', 'PURPLE', 'PassiveBuzzer', 'Path', 'PinAlreadyInUseError', 'PinError', 'PinNotApplicableError', 'PinOutOfRangeError', 'Potentiometer', 'RED', 'REST', 'RGB', 'RGBled', 'RIGHT', 'RaspberryPiPico', 'RaspberryPiPicoW', 'ReservedPinWarning', 'SEC', 'SKY_BLUE', 'SLIGHT_LEFT', 'SLIGHT_RIGHT', 'STM32BlackPill', 'STM32BluePill', 'SeeeduinoXIAO', 'SeeeduinoXIAOESP32C3', 'SerialMoniter', 'ServoMotor', 'TEAL', 'Teensy40', 'Teensy41', 'TwoWheeledDriver', 'UNIMPORTANT', 'US', 'UTMOST_IMPORTANCE', 'UltrasonicSensor', 'WHITE', 'Wifi', 'YELLOW', 'a', 'check_I2C_devices', 'cl', 'classes', 'dat', 'f', 'file', 'find_I2C_Devices', 'get_current_board', 'getall', 'interrupt', 'name', 'op', 'reserved_pin_warn', 'set_board', 'user_config_dir', 'sleep', 'warn']
__all__ = [
      "stop" if name == "interrupt" else "wait" if name == "sleep" else name
      for name in __all__
]
